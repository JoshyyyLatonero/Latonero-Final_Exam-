...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      $message[] = 'PLEASE FILL IT ALL OUT';
        ...
        $insert = "INSERT INTO destination(name, price, image) VALUES('$product_name', '$product_price', '$product_image')";
        ...
        <div class="pdisplay">
            <table class="pdtable">
                ...
                <tr>
                    ...
                    <td>
                        <a href="http://localhost/Joshlat/update.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> Edit </a>
